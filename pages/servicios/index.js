...
export default function Servicios() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      element.querySelector(`#consultoria-services`),
      {
        opacity: 0,
        y: "200%",
      },
        ...
        <div className="services-content">
            ...
            <ul className="services-nav">
              {services.map((s) => (
                <li key={s.id} className="services-nav__item">
                  <i className={`fas fa-${s.icon} services-nav__icon`}></i>
                  <Link href={`/${s.link}`}>
                    <a
                      onClick={(e) => {
                        handleClick(e);
          ...
          <div className="services-content-paragraph">
            ...
            <p className="services-paragraph">
              ...
              adapte mejor a la realidad cambiante del mundo empresarial actual
              y prepararse para el que viene. Anticiparse y prepararse para esto
              requiere orientación y conocimientos específicos de la industria.
            </p>
            <p className="services-paragraph">
              Nuestra visión tecnológica y nuestros servicios de asesoría ayudan
              a evolucionar las organizaciones y a generar valor comercial
              gracias a arquitecturas tecnológicas adaptadas a tú industria.
            </p>
          </div>
          <div className="services-content__services" id="consultoria">
            <div className="services-consultoria">
              <h2 className="Title" id="consultoria-services">
              ...
              <div className="services-consultoria__content" id="consultoria-1">
                <p className="services-consultoria__paragraph">
                  ...
                  prácticamente todas las áreas empresariales, es más importante
                  que nunca que las organizaciones comprendan cómo aprovechar al
                  máximo el rendimiento y los datos que arrojan las diversas
                  tecnologías.
                </p>
              </div>
              ...
              <div className="services-consultoria__content" id="consultoria-2">
                <ul className="services-consultoria__ul">
                  <li className="services-consultoria__item consultoria-items-2">
                    ...
                    sus esfuerzos en un objetivo establecido, lo que aumenta la
                    rentabilidad del negocio en sí.
                  </li>
                  <li className="services-consultoria__item consultoria-items-2">
                    Acelerar tu crecimiento, reducir costos, disminuir riesgos,
                    atraer y desarrollar talentos y optimizar procesos
                    importantes
                  </li>
                  <li className="services-consultoria__item consultoria-items-2">
              ...
              <div className="services-consultoria__content" id="consultoria-3">
                ...
                <p className="services-consultoria__paragraph sub-1 consultoria-items-3">
                  ...
                  análisis del personal porque el factor humano juega un papel
                  muy importante. Las siguientes preguntas nos ayudan a evaluar
                  muchos puntos de vista y análisis general:
                </p>
                <ul className="services-consultoria__ul sub-1">
                  ...
                  <li className="services-consultoria__item consultoria-items-3">
                    ¿Tiene planes u objetivos para la nueva tecnología o la que
                    ya estás utilizando?
                  </li>
                  <li className="services-consultoria__item consultoria-items-3">
                ...
                <p className="sub-3 services-consultoria__paragraph consultoria-items-3">
                  En esta etapa la propuesta y recomendaciones que hemos tomado
                  se basa en toda la información que se ha solicitado para
                  devolver ideas sólidas. Teniendo en cuenta todo lo que
          ...
          <div
            ...
            id="organizacion-y-logistica"
          >
            <div className="services-logistica">
              <h2 className="Title">Organización y logística Interna</h2>
            </div>
          </div>
          <div className="services-content__services" id="landing-page">
            <div className="services-logistica">
              <h2 className="Title">Creación de sitio Web</h2>
            </div>
          </div>
          <div className="services-content__services" id="web-app">
            <div className="services-logistica">
              <h2 className="Title">Aplicaciones Web</h2>
            </div>
          </div>
          <div className="services-content__services" id="tienda-online">
            <div className="services-logistica">
              <h2 className="Title">Desarrollo de Tienda Online</h2>
            </div>
          </div>
          <div className="services-content__services" id="marketing-digital">
            <div className="services-logistica">
