      ...
      <div className="services-content">
        ...
        <div className="services-logistica__content_paragraph">
          <p className="services-paragraph">
            ...
            control de stock, sistemas de automatización, manejo de materiales,
            equipamientos y tecnología interna como software entre otros.
          </p>
        </div>
        <h3
        ...
        <div className="services-logistica__content_paragraph">
          <p className="services-paragraph">
            Un buen uso de la misma trae muchos beneficios y un salto exponecial
            en un mercado cada vez más competitivo. Una mala práctica en la
            logística interna crea problemas en la movilización de los
            materiales que suministran la línea de producción o una mala
            comunicación que a su vez afecta a toda la organización. Siendo así,
            el proceso productivo inviable al igual que la distribución física.
          </p>
          <p className="services-paragraph">
